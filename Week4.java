...
//File: Week4.java
//Date: August 28 2020
//Purpose: COIT11222 assignment one question four T2-20
//Repetition while and for loops - Repeat the entry of customer
//name, contact phone and water usage N times, where N is the largest
//digit in your student ID, identify the number of customers who used
//more than 90KL and calculate the average charge of all customers
...
public class Week4
{
	public static void main (String[] args)
	{
		...
		//Integer declaration for the total customer charge, used to calculate the average
		double totalCustomersCharge = 0;
		//Integer declaration for the average customer charge
		double averageCustomersCharge = 0;
		//Integer declaration to count how many customers exceed 90KL
		int excessWaterCount = 0;
		...
		//Outputs the title for the application
		System.out.printf("%84s", "Welcome to Urban Utilities Water Charge Application Program\n");
		//Outputs the dashed line below the application title
		...
		for (int lcv = 0; lcv < N; lcv++)
		{
			...
			else
			{
				...
				//Add 1 to the counter to store number of people using over 90KL of water
				excessWaterCount ++;
			}
			...
			totalCustomersCharge += customerTotalCharge;
			...
			//Leaves 2 blank lines between the end of the receipt and the statistical data
			System.out.print("\n\n");

		}

		//Outputs the number of customers with water usage exceeding 90KL quartely
		System.out.printf(receiptOffsetSpacing + "The number of customers with water usage exceeding 90KL quartely: " + excessWaterCount + "\n\n");

		//Calculates the average customer charge (totalCustomersCharge / N)
		averageCustomersCharge = (totalCustomersCharge / N);

		//Outputs the average customer charge below the receipt
		System.out.printf(receiptOffsetSpacing + "The average charge of all customers: " + "$%.2f", averageCustomersCharge);
		System.out.print("\n\n");
